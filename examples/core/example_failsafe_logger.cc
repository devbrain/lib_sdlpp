...
class failsafe_logger_app : public sdlpp::application {
public:
    failsafe_logger_app() : sdlpp::application({
        .sdl_flags = sdlpp::init_flags::video | sdlpp::init_flags::events,
        .window_title = "Failsafe Logger Example",
        .window_width = 800,
        .window_height = 600
    }) {}
