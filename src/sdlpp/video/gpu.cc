...
namespace sdlpp::gpu {
    ...
    std::ostream& operator<<(std::ostream& os, texture_usage value) {
        ...
        if ((static_cast <unsigned int>(value) & static_cast <unsigned int>(texture_usage::sampler)) != 0) {
            active_flags.push_back("sampler");
        }
        if ((static_cast <unsigned int>(value) & static_cast <unsigned int>(texture_usage::color_target)) != 0) {
            active_flags.push_back("color_target");
        }
        if ((static_cast <unsigned int>(value) & static_cast <unsigned int>(texture_usage::depth_stencil_target)) !=
            0) {
            active_flags.push_back("depth_stencil_target");
        }
        if ((static_cast <unsigned int>(value) & static_cast <unsigned int>(texture_usage::graphics_storage_read)) !=
            0) {
            active_flags.push_back("graphics_storage_read");
        }
        if ((static_cast <unsigned int>(value) & static_cast <unsigned int>(texture_usage::compute_storage_read)) !=
            0) {
            active_flags.push_back("compute_storage_read");
        }
        if ((static_cast <unsigned int>(value) & static_cast <unsigned int>(texture_usage::compute_storage_write)) !=
            0) {
            active_flags.push_back("compute_storage_write");
        }
        if ((static_cast <unsigned int>(value) & static_cast <unsigned int>(
                 texture_usage::compute_storage_simultaneous_read_write)) != 0) {
            active_flags.push_back("compute_storage_simultaneous_read_write");
        }
    ...
    std::istream& operator>>(std::istream& is, texture_usage& value) {
        ...
        while (start < str.length()) {
            ...
            if (flag_name == "graphics_storage_read") {
                value = static_cast <texture_usage>(
                    static_cast <unsigned int>(value) | static_cast <unsigned int>(
                        texture_usage::graphics_storage_read));
                found = true;
            }
            if (flag_name == "compute_storage_read") {
                value = static_cast <texture_usage>(
                    static_cast <unsigned int>(value) | static_cast <unsigned int>(
                        texture_usage::compute_storage_read));
                found = true;
            }
            if (flag_name == "compute_storage_write") {
                value = static_cast <texture_usage>(
                    static_cast <unsigned int>(value) | static_cast <unsigned int>(
                        texture_usage::compute_storage_write));
                found = true;
            }
