...
#ifndef SDLPP_INCLUDE_SDLPP_VIDEO_COLOR_NAMES_HH_
#define SDLPP_INCLUDE_SDLPP_VIDEO_COLOR_NAMES_HH_

#include <sdlpp/video/color.hh>

namespace neutrino::sdl::colors {
...
#endif //SDLPP_INCLUDE_SDLPP_VIDEO_COLOR_NAMES_HH_
