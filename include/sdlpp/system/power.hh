...
namespace neutrino::sdl {
	...
	template<typename T>
	static constexpr const decltype(detail::s_vals_of_power_state)&
	values(std::enable_if_t <std::is_same_v <power_state, T>>* = nullptr) {
		return detail::s_vals_of_power_state;
	}

	template<typename T>
	static constexpr auto
	begin(std::enable_if_t <std::is_same_v <power_state, T>>* = nullptr) {
		return detail::s_vals_of_power_state.begin();
	}

	template<typename T>
	static constexpr auto
	end(std::enable_if_t <std::is_same_v <power_state, T>>* = nullptr) {
