...
namespace neutrino::sdl {
	namespace detail {
		struct _touch_device_;
		struct _touch_id_;
		struct _touch_finger_;
	}

	using touch_device_t = strong::type<std::size_t,
										detail::_touch_device_,
										strong::bicrementable,
										strong::ordered,
										strong::equality,
										strong::ostreamable>;
	using touch_id_t = strong::type<SDL_TouchID,
									detail::_touch_id_,
									strong::bicrementable,
									strong::ordered,
									strong::equality,
									strong::ostreamable>;
	using touch_finger_t = strong::type<std::size_t,
										detail::_touch_finger_,
										strong::bicrementable,
										strong::ordered,
										strong::equality,
										strong::ostreamable>;
