...
namespace neutrino::sdl {
	...
	class sensor : public object<SDL_Sensor> {
	 public:
		...
		template <class T>
		std::vector<T>
		get_data (std::size_t num_values, typename std::enable_if<std::is_same_v<T, float>>::type* = nullptr) const;
	...
	inline
	std::vector<T>
	sensor::get_data (std::size_t num_values, typename std::enable_if<std::is_same_v<T, float>>::type*) const {
	...
	template <class T>
	std::vector<T>
	sensor::get_data (std::size_t num_values, typename std::enable_if<std::is_same_v<T, timed_data_t>>::type*) const {
