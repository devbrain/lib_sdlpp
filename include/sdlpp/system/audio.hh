...
namespace neutrino::sdl {
	...
	class SDLPP_EXPORT audio {
	 public:
		...
		static void
		play (audio_channel_id_t chan, unsigned loops, std::chrono::milliseconds ticks, const object<Mix_Chunk>& effect);
		...
		static bool
		play_on_first_available_channel (unsigned loops, std::chrono::milliseconds ticks, const object<Mix_Chunk>& effect);
		...
		static void
		fade_in (audio_channel_id_t chan, unsigned loops, std::chrono::milliseconds ticks, const object<Mix_Chunk>& effect);
		...
		static bool
		fade_in_on_first_available_channel (unsigned loops, std::chrono::milliseconds ticks, const object<Mix_Chunk>& effect);
		static bool
		...
		static void
		fade_in (audio_channel_id_t chan, unsigned loops, std::chrono::milliseconds effect_duration, std::chrono::milliseconds ticks, const object<
			Mix_Chunk>& effect);
		static void
		fade_in (audio_channel_id_t chan, std::chrono::milliseconds effect_duration, std::chrono::milliseconds ticks, const object<
			Mix_Chunk>& effect);
		static void
		fade_in_inf (audio_channel_id_t chan, std::chrono::milliseconds effect_duration, std::chrono::milliseconds ticks, const object<
			Mix_Chunk>& effect);
		static bool
		fade_in_on_first_available_channel (unsigned loops, std::chrono::milliseconds effect_duration, std::chrono::milliseconds ticks, const object<
			Mix_Chunk>& effect);
		static bool
		fade_in_on_first_available_channel (std::chrono::milliseconds effect_duration, std::chrono::milliseconds ticks, const object<
			Mix_Chunk>& effect);
		static bool
		fade_in_on_first_available_channel_inf (std::chrono::milliseconds effect_duration, std::chrono::milliseconds ticks, const object<
			Mix_Chunk>& effect);
		...
		static void
		fade_in (unsigned loops, std::chrono::milliseconds ticks, std::chrono::milliseconds pos, const object<Mix_Music>& mus);
		static void
		fade_in (unsigned loops, std::chrono::milliseconds ticks, std::chrono::seconds pos, const object<Mix_Music>& mus);
		static void
