 ...
 *   - @c <simplex/collide/types.hh>     value types + result types
 *   - @c <simplex/collide/distance.hh>  closest-point / squared-distance queries
 *   - @c <simplex/collide/overlap.hh>   static boolean overlap predicates
 *   - @c <simplex/collide/sweep.hh>     parametric + continuous collision queries
 *   - @c <simplex/collide/triangle.hh>  solid-triangle narrow-phase (slopes/ramps)
 *
 ...
 *     overlapping)
 *
 * The solid @c triangle (slopes/ramps) lives in @c <simplex/collide/triangle.hh>; its narrow-phase
