 ...
 * @brief The pooled node arena (@ref simplex::collide::aabb_tree_storage) backing the dynamic AABB
 *        tree.
 *
 * A slot-recycling arena of @ref simplex::collide::dynamic_aabb_node, addressed by @ref
 * simplex::collide::node_ptr. Freed slots are reused via an intrusive free list, and a freed slot
 * is stamped @ref simplex::collide::FREE_NODE_HEIGHT to catch double frees.
 */
