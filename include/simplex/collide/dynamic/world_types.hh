...
/**
 * @file world_types.hh
 * @brief The public vocabulary of the @ref simplex::collide::world API -- shapes, materials,
 ...
 * directly). It defines:
 *   - shape variants: @ref simplex::collide::shape_t (any shape) and @ref
 *     simplex::collide::moving_shape_t (movers only).
 *   - per-collider properties: @ref simplex::collide::response_mode, @ref
 *     simplex::collide::material_props, @ref simplex::collide::filter_props.
 *   - the input DTOs handed to @ref simplex::collide::world::add: @ref simplex::collide::static_body,
 *     @ref simplex::collide::kinematic_body, @ref simplex::collide::carrier_body, @ref
 *     simplex::collide::bullet, @ref simplex::collide::tile_body.
 *   - the opaque handle @ref simplex::collide::collider_id (plus its @c std::hash specialization).
 *   - query/event results: @ref simplex::collide::contact, @ref simplex::collide::footing, @ref
 *     simplex::collide::event_kind, @ref simplex::collide::world_event.
 *   - construction config: @ref simplex::collide::world_config.
 *
...
/**
 * @brief @c std::hash specialization so @ref simplex::collide::collider_id keys an
