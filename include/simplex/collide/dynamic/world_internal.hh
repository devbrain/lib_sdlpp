 ...
 * @brief The @c simplex::collide::detail implementation types behind @ref simplex::collide::world.
 *
 ...
 *   - @ref simplex::collide::detail::tile -- the static grid's per-cell payload.
 *   - @ref simplex::collide::detail::body_kind / @ref simplex::collide::detail::resident_body /
 *     @ref simplex::collide::detail::nonresident_body -- the stored body records.
 *   - @ref simplex::collide::detail::internal_storage -- the generation-tracked slot-map arena
 *     (with @c bodies_storage / @c bullets_storage aliases) and its live-only iterator.
 *   - @c narrow / @c widen -- shape-variant conversions between @ref simplex::collide::shape_t and
 *     @ref simplex::collide::moving_shape_t.
 *   - @ref simplex::collide::detail::eval_velocity_response -- the surface-material velocity response.
...
namespace simplex::collide::detail {
    /**
