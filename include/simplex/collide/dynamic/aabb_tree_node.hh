 ...
 *        simplex::collide::dynamic_aabb_tree).
 *
 * Defines @ref simplex::collide::node_ptr (a strongly-typed index into the node arena), @ref
 * simplex::collide::dynamic_aabb_node (one tree node -- leaf or internal), and the @ref
 * simplex::collide::FREE_NODE_HEIGHT sentinel. Nodes are addressed by @c node_ptr rather than raw
