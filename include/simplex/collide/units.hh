 ...
 * simplex::collide::units::fraction is multiplied in where a @ref
 * simplex::collide::units::duration belongs, or a @ref simplex::collide::units::velocity is used
 * as a @ref simplex::collide::units::displacement.
 *
